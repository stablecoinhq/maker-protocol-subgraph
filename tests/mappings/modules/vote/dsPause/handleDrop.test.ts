...
describe("dsPause#handleDrop test", () => {

    test('dsPause#handleDrop succeeds', () => {
        ...
        assert.fieldEquals('VoteLogDrop', voteLogId, "usr", usr.toLowerCase())
        assert.fieldEquals('VoteLogDrop', voteLogId, "tag", tag)
        assert.fieldEquals('VoteLogDrop', voteLogId, "fax", fax)
        assert.fieldEquals('VoteLogDrop', voteLogId, "eta", eta)
        clearStore()
    })
})